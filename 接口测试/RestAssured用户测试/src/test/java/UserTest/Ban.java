...
public class Ban {
    ...
    public void correctAddTest(){
        ...
        given().
                ...
                when().
                post(url + "/user/ban/2c90d7068c82ae90018c875a70a2000e").
                then().
                statusCode(200).
                body("code",equalTo(0)).
    ...
    public void WrongUsernameTest(){
        ...
        given().
                ...
                body(request).contentType(ContentType.JSON).
                when().
                post(url + "ban/2c90d7068c82ae90018c875").
                then().
                statusCode(200).
                body("code",equalTo(-1)).
    ...
    public void noAuthorityTest(){
        String sessionId = getLoginSession("quanxingrun","123456");
        String request =  "" +
                "}\n";
        given().
                cookie("JSESSIONID",sessionId).
                body(request).contentType(ContentType.JSON).
                when().
                put(url + "/user/ban/2c90d7068c82ae90018c875a70a2000e").
                then().
                body("code",equalTo(-1)).
